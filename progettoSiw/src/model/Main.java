...
public class Main {
	public static void main(String[] args){
		...
		//		4.cancella attività esistente
		//	5. crea attività
		////
		////5-gestioneRendimentoOgniCentro
		//	1 responsabile genrale accede al sistema e visualizza i vari centri
		//	2 per ogni centro visualizza attraverso il sistema la lista degli allievi iscritti ad ogni attvità
		//	3 restituisce una classifica dei centri in base al quantitativo di iscritti
